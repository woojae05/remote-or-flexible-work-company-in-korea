...
1. 우리는 이렇게 일해요
    ...
    - 위로로 함께 일해요
    - 갈등과 협의를 불편해하지 않아요
    - 서로의 자율을 위해 함께 책임을 분담해요
    - 적극적, 능동적 업무를 통해 함께 성장해요

2. 자유롭고, 효율적인 근무 환경을 지원해요
    - 오전 7시부터 11시까지 자율출근제도
    - 매주 금요일은 1시간 단축근무
    - 사유 상관없이 자유로운 휴가 사용
    - 생일 3시간 조기 퇴근

3. 직원들의 개인 역량을 위해 아낌없이 지원해요
    - 업무 관련 도서와 세미나로 개인의 성장 지원
    - 맛잘알 셰프님이 든든하고 맛있는 점심 식사 제공
    - 다양한 간식 상시 구비
    - 행복하고 든든한 휴일을 위해 연차휴가비 지원
    - 근속년수에 따른 리프레쉬 휴가와 상여금 지급

4. 특별한 날을 함께 기념해요
- 생일에는 센스가 가득 담긴 기프티콘 선물
- 근로자의 날 모든 팀원에게 마음을 담은 선물 전달
- 어버이날에는 멋진 동료를 낳아주신 부모님께 감사의 선물 전달

_**아임웹이 더 궁금하다면?**_
[홈페이지](https://imweb.me/)  
[채용공고](https://recruit.imweb.me/)

### 네오사피엔스

- 무제한 유급휴가
- 점심, 저녁, 간식, 음료 무료 제공 (금액 제한 없음)
- 직원들이 직접 주문하는 간식 (금액 제한 없음)
- 자기계발, 도서, 세미나, 체력단련 지원 (금액 제한 없음)
- 분기별 조직문화 활성화 전문 퍼실리테이터가 진행
- 전문코치의 커리어코칭 (무료)
- 사내 추천 채용 보상제도 운영 (최소 200만원)
- 컴퓨터 주변 기기 무제한 제공
- 스톡옵션 제공
- 건강검진, 경조사지원금 등 기본적인 것은 언급하지 않았습니다.
